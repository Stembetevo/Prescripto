  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5'>
        <button className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFitler?'bg-primary text-white':''}`} onClick={()=>setShowFilter(prev => !prev)}>Filters</button>
        <div className={` flex-col gap-4 text-sm text-gray-600 ${showFitler?'flex':'hidden sm:flex'} `}>
